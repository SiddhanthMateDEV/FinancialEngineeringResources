...
std::tuple<int,std::map<std::string,int>,std::map<std::string,std::map<std::string,int>>> MarketDataAPIFunctions::Quotes(const std::string& token,
                               const int& exchangeSegment,
                               const int& exchangeSegmentID,
